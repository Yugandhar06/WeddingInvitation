google.maps.__gjsload__('search', function(_) {
    var Uxa = function(a) {
      ...
      , Txa = function(a) {
        ...
        const d = [];
        a.Sv().forEach(e => {
            e.a && e.a.length >= 2 && d.push(new Vxa(e,b,c))
        }
        );
        return d
    }
      , Wxa = class extends _.fo {
    }
    ;
    var Xxa = {
        ["1"]: {}
      ...
      , Vxa = class {
        ...
        getAnchor() {
            if (!this.anchor) {
                const a = 1 << this.zoom;
                this.anchor = _.Nr(new _.br((this.Bo.x * 256 + this.source.a[0]) / a,(this.Bo.y * 256 + this.source.a[1]) / a)).toJSON()
            }
            return this.anchor
        }
        getCompleteBounds() {
      ...
      , EH = class extends Wxa {
        ...
        changed() {
            ...
            _.Wl("search_impl").then(d => {
                d.mh(a);
                c && (d = Number(c.get("blockingLayerCount")) || 0,
